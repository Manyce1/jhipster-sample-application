...
import { FirstApplicationSharedModule } from 'app/shared';
import { FirstApplicationCoreModule } from 'app/core';
import { FirstApplicationAppRoutingModule } from './app-routing.module';
import { FirstApplicationHomeModule } from './home/home.module';
import { FirstApplicationAccountModule } from './account/account.module';
...
@NgModule({
  imports: [
    ...
    FirstApplicationSharedModule.forRoot(),
    FirstApplicationCoreModule,
    FirstApplicationHomeModule,
    FirstApplicationAccountModule,
